...
#Агент Player - играет в игру, выдает случайные числа от 0 до 15 и складывает их отправяя каждую этерацию сумму 
#GameMaster зная секретное число, сравнивает их с приходящей суммой 
